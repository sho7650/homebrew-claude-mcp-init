...
class SerenaPlugin(MCPModule):
    ...
    def generate_config_files(self, project_path: Path, config: Dict[str, Any]) -> None:
        ...
        logger.info("✓ Using official Serena schema with gitignore integration")
    ...
    def post_install_hook(self, project_path: Path, config: Dict[str, Any]) -> None:
        ...
        if language in ['python', 'javascript', 'typescript']:
            logger.info("💡 Tip: Serena works best with well-structured codebases")
        elif language == 'rust':
            logger.info("💡 Tip: Ensure your Cargo.toml is in the project root")
        elif language == 'go':
            logger.info("💡 Tip: Ensure your go.mod is in the project root")