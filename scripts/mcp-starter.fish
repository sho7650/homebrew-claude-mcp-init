...
metadata:
  ...
  created_by: mcp-starter" > $config_file
...
function main
    ...
    if test (count $argv) -lt 1
        print_color "Usage: mcp-starter.fish <project_name> [language]" red
        print_color "Example: mcp-starter.fish my-project typescript" yellow
        exit 1
    end
